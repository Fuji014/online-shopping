package net.ekong.onlineshopping.controller;
...
import net.ekong.onlineshopping.util.FileUtil;
import net.ekong.onlineshopping.validator.ProductValidator;
import net.ekong.shoppingbackend.dao.CategoryDAO;
import net.ekong.shoppingbackend.dao.ProductDAO;
import net.ekong.shoppingbackend.dto.Category;
