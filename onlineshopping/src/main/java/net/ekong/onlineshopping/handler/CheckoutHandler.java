package net.ekong.onlineshopping.handler;
...
import net.ekong.onlineshopping.model.CheckoutModel;
import net.ekong.onlineshopping.model.UserModel;
import net.ekong.shoppingbackend.dao.CartLineDAO;
import net.ekong.shoppingbackend.dao.ProductDAO;
import net.ekong.shoppingbackend.dao.UserDAO;
import net.ekong.shoppingbackend.dto.Address;
import net.ekong.shoppingbackend.dto.Cart;
import net.ekong.shoppingbackend.dto.CartLine;
import net.ekong.shoppingbackend.dto.OrderDetail;
import net.ekong.shoppingbackend.dto.OrderItem;
import net.ekong.shoppingbackend.dto.Product;
